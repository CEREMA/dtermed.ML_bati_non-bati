...
- garder la taille des images
- changer le nombre de filtres
- enlever / rajouter des couches de convolutions
- changer le nb de neurones de la couche entièrement connectée
- rajouter une couche entièrement connectée intermédiaire
- mettre des couches de dropout si overfitting
- ajouter l'augmentation des données
- utiliser adam en optimizer
'''
...
print('***********************************************************')
print('*************** Initialisation du test n° 3 ***************')
print('***********************************************************')
