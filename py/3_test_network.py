...
print(value_predict)
formulation = "[INFO] bati = "+str((1-value_predict)*100)+" %" if value_predict < 0.5 else "[INFO] non_bati = "+str(value_predict*100)+" %"
print(formulation)

# build the label
label = "bati" if value_predict < 0.5 else "non_bati"
